...
import com.chems.demoapp.config.KafkaProperties;
...
class JhipsterDemoKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterDemoKafkaResource kafkaResource = new JhipsterDemoKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-demo-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-demo-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
